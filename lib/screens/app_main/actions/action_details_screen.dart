...
//
// import '../../bottom_navigation/categories/category_screen.dart';
//
...
//     super.initState();
//     UserAction userAction = ActionGetxController().getUserActionById();
//     _actionAmountTextController =
//         TextEditingController(text: userAction.amount.toString());
//     _noteTextController = TextEditingController(text: userAction.notes);
//     // _currency = userAction.currency;
//     // _category = userAction.category;
//     _pickedDateValue = userAction.date;
//   }
//
//   @override
//   void dispose() {
